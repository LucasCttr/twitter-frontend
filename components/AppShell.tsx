    ...
    <div className="relative z-20 min-h-screen w-full flex flex-col" style={{ backgroundColor: '#18181c' }}>
      ...
      <div className="w-full flex justify-center items-start">
        <div className="xl:grid xl:grid-cols-[340px_minmax(0,45rem)_340px] xl:gap-0 mx-auto">
          <aside
            className="hidden xl:block w-[340px] p-4 pt-6 sticky top-0 border-r border-white/30"
            style={{ backgroundColor: '#18181b', borderLeft: '1px solid rgba(255, 255, 255, 0.28)' }}
          >
            <div className="sticky top-0 -translate-y-4">
              <nav aria-label="Main menu">
                <ul className="space-y-4">
                  <li>
                    <a href="/" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/explore" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/notifications" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/following" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/messages" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/bookmarks" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
                  ...
                  <li>
                    <a href="/profile" className="flex items-center gap-8 px-6 py-4 rounded-md hover:bg-white/3 text-zinc-100">
          ...
          <aside
            className="hidden xl:block w-[360px] p-4 pt-6 sticky top-0 border-l border-white/30"
