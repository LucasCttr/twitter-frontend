...
export default function TweetDetailClient({ tweet }: { tweet: Tweet }) {
  ...
  return (
    <main className="w-full border border-zinc-800" style={{ backgroundColor: '#0b0b0b' }}>
      <div className="">
        <TweetCard tweet={tweet} noBorderTop />
      </div>
      <section className="border-t border-zinc-800">
        <form onSubmit={handleCommentSubmit} className="p-4 border-b border-zinc-800 bg-transparent">
